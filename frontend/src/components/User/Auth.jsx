...
import homepage from '../../assests/images/hompage3.jpg';
            ...
            <div className="flex w-full h-screen md:w-2/3 py-8 mx-auto">
                ...
                <div className="flex flex-col gap-3 w-full md:w-2/5">
                    ...
                    <div className="flex gap-3 justify-center" >
                        <img draggable="false" width="130px" src={appstore} alt="appstore" />
                        <img draggable="false" width="130px" src={playstore} alt="playstore" />
                    </div>
