...
const Login = () => {
    ...
    return (
        <>
            ...
            <Auth>
                <h1><b><center>PHOTO-MEDIA</center></b></h1>
                <div className="bg-white border flex flex-col gap-2 p-4 pt-10">
                    <img draggable="false" className="mx-auto h-30 w-36 object-contain" src="https://images.squarespace-cdn.com/content/v1/5ab97fe370e802ab2c6dc029/1609301975413-VQ2KPM4E98SAU9XELS33/secondary%2Blogo%2B%25284%2529.jpg" alt="" />
