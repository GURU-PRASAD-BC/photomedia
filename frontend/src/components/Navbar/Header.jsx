    ...
    return (
        <nav className="fixed top-0 w-full border-b bg-white z-10">
            ...
            <div className="flex flex-row justify-between items-center py-2 px-3.5 sm:w-full sm:py-2 sm:px-4 md:w-full md:py-2 md:px-6 xl:w-4/6 xl:py-3 xl:px-8 mx-auto">
                ...
                {/* <!-- logo --> */}
                <Link to="/"><img draggable="false" className="mt-1.5 w-full h-full object-contain" src="https://images.squarespace-cdn.com/content/v1/5ab97fe370e802ab2c6dc029/1609301975413-VQ2KPM4E98SAU9XELS33/secondary%2Blogo%2B%25284%2529.jpg" alt="" /></Link>
